...
public class VillagerArmorModel extends HierarchicalModel<AbstractVillager> implements IHumanoidModel, VillagerHeadModel {
	...
	public static LayerDefinition createBodyLayer(CubeDeformation cubeDeformation, float y, float legsExtend) {
		...
		partdefinition.addOrReplaceChild("right_leg",
				CubeListBuilder.create().texOffs(0, 16).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, cubeDeformation.extend(legsExtend)),
				PartPose.offset(-2.0F, 12.0F + y, 0.0F));
		partdefinition.addOrReplaceChild("left_leg",
				CubeListBuilder.create().texOffs(0, 16).mirror().addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, cubeDeformation.extend(legsExtend)),
				PartPose.offset(2.0F, 12.0F + y, 0.0F));
